...
let categories = [] // This to store categories from the first API call
...
async function renderClues(i, j) {
  ...
  try {
    ...
    // need to do some data cleaning of clue answers (e.g. remove html formatting and situations like the answer is spaced")
...
// if the player picked the correct answer
function checkAnswer() {
  if (document.querySelector("input").value != "") {
    playerAnswer = document.querySelector("input").value
  }
  else {
    playerAnswer = "no-answer!" // if no answer given
  }
...
// countdown timer code referenced from stackoverflow: https://stackoverflow.com/questions/31106189/create-a-simple-10-second-countdown
function countDown() {
  timeleft = 10;
